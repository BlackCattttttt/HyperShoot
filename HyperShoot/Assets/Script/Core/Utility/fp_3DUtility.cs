...
public static class fp_3DUtility
{
	...
	public static GameObject DebugPrimitive(PrimitiveType primitiveType, Vector3 scale, Color color, Vector3 pivotOffset, Transform parent = null)
	{
		...
		fp_MaterialUtility.MakeMaterialTransparent(mat);
		mat.color = color;
	...
	{
		return fp_3DUtility.DebugPrimitive(PrimitiveType.Sphere, new Vector3(0.01f, 0.01f, 3), new Color(1, 1, 0, 0.75f), Vector3.forward, parent);
	}
	...
	{
		return fp_3DUtility.DebugPrimitive(PrimitiveType.Sphere, Vector3.one * 0.25f, new Color(1, 0, 0, 0.5f), Vector3.zero, parent);
	}
