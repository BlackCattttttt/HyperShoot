...
public class fp_MessageBox : EditorWindow
{
	...
	{
		Create(mode, caption, message, delegate(fp_MessageBox.Answer answer) { });
	}
	...
	public static void Create(Mode mode, string caption, string message, Callback callback)
	{
		...
		fp_MessageBox msgBox = (fp_MessageBox)EditorWindow.GetWindow(typeof(fp_MessageBox), true);
