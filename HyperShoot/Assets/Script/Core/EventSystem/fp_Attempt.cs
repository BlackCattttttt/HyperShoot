...
/// </summary>
public class fp_Attempt : fp_Event			// non-generic version for 0 arguments
{
	...
	///
	/// </summary>
	public fp_Attempt(string name) : base(name)
	{
		InitFields();
	}
	...
	protected override void InitFields()
	{
		...
		m_DelegateTypes = new Type[] { typeof(fp_Attempt.Tryer) };
	...
	{
		Try = (fp_Attempt.Tryer)fp_Attempt.Tryer.CreateDelegate(m_DelegateTypes[v], t, m);
		Refresh();
	}
...
/// </summary>
public class fp_Attempt<V> : fp_Attempt			// generic version with 1 argument
{
