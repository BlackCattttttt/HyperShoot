...
public sealed class fp_ComponentPreset
{
	...
	public static string Save(Component component, string fullPath)
	{
		...
		preset.InitFromComponent(component as fp_Component);
	...
	/// saves every supported field of 'preset' to text at 'fullPath'
	/// </summary>
	public static string Save(fp_ComponentPreset savePreset, string fullPath, bool isDifference = false)
	{
	...
	/// </summary>
	public static string SaveDifference(fp_ComponentPreset initialStatePreset, Component modifiedComponent, string fullPath, fp_ComponentPreset diskPreset)
	{
		...
		fp_ComponentPreset modifiedPreset = new fp_ComponentPreset();
		modifiedPreset.InitFromComponent(modifiedComponent as fp_Component);

		// create an empty preset of the same type
		fp_ComponentPreset result = new fp_ComponentPreset();
	...
	/// </summary>
	public void InitFromComponent(fp_Component component)
	{
	...
	/// </summary>
	public static fp_ComponentPreset CreateFromComponent(fp_Component component)
	{
	...
	/// 
	/// </summary>
	public int TryMakeCompatibleWithComponent(fp_Component component)
	{
	...
	/// </summary>
	public static bool Load(fp_Component component, string fullPath)
	{
	...
	/// </summary>
	public static fp_ComponentPreset LoadFromResources(fp_Component component, string resourcePath)
	{
	...
	/// the values on 'component', then returns the preset
	/// </summary>
	public static fp_ComponentPreset LoadFromTextAsset(fp_Component component, TextAsset file)
	{
	...
	/// case of heavy refactoring of fp_Components, rather than crashes
	/// </summary>
	...
	Dictionary<string, string[]> MovedParameters = new Dictionary<string, string[]>()
		{
			...
			{ "fp_FPCamera.MouseAcceleration", new string [] {"fp_FPInput", "MouseLookAcceleration"} },
			{ "fp_FPCamera.MouseSensitivity", new string [] {"fp_FPInput", "MouseLookSensitivity"} },
			{ "fp_FPCamera.MouseSmoothSteps", new string [] {"fp_FPInput", "MouseLookSmoothSteps"} },
	...
	/// </summary>
	public static bool Apply(fp_Component component, fp_ComponentPreset preset)
	{

		if (preset == null)
		{
			Error("Tried to apply a preset that was null in '" + fp_Utility.GetErrorLocation() + "'");
			return false;
		}

		if (preset.m_ComponentType == null)
		{
			Error("Preset ComponentType was null in '" + fp_Utility.GetErrorLocation() + "'");
			return false;
		}

		if (component == null)
		{
			UnityEngine.Debug.LogWarning("Warning: Component was null when attempting to apply preset in '" + fp_Utility.GetErrorLocation() + "'");
			return false;
		}
		...
		if (component.Type != preset.m_ComponentType)
		{
			...
			Error("Applied " + type + " to a '" + component.Type.ToString() + "' component in '" + fp_Utility.GetErrorLocation() + "'");
			return false;
		}
