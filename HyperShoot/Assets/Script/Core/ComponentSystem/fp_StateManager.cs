...
public class fp_StateManager
{
    private fp_Component m_Component = null;            // component to manipulate

    [System.NonSerialized]  // NOTE: made non-serialized to prevent serialization depth error on Unity 4.5
    private List<fp_State> m_States = null;             // list sent from the component at startup. IMPORTANT: must not be altered at runtime
	...
	public fp_StateManager(fp_Component component, List<fp_State> states)
	{
		...
		foreach (fp_State s in m_States)
		{
	...
	/// </summary>
	public void ImposeBlockingList(fp_State blocker)
	{
	...
	/// </summary>
	public void RelaxBlockingList(fp_State blocker)
	{
