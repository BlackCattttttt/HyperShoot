...
/// 'Argument' property.
/// </summary>
public class fp_Activity : fp_Event			// non-generic version for 0 arguments
{
	...
	protected fp_Timer.Handle m_ForceStopTimer = new fp_Timer.Handle();
	...
	///
	/// </summary>
	public fp_Activity(string name)
		: base(name)
	{
		InitFields();
	}
	...
	protected override void InitFields()
	{
		...
		m_DelegateTypes = new Type[] {	typeof(fp_Activity.Callback),
										typeof(fp_Activity.Callback),
										typeof(fp_Activity.Condition),
										typeof(fp_Activity.Condition),
										typeof(fp_Activity.Callback),
										typeof(fp_Activity.Callback)};
		...
		set
		{
			if ((value == true) && !m_Active)
			{
				...
				if (m_MaxDuration > 0.0f)
					fp_Timer.In(m_MaxDuration, delegate() { Stop(); }, m_ForceStopTimer);
			}
...
/// 'Argument' property.
/// </summary>
public class fp_Activity<V> : fp_Activity			// generic version with 1 argument
{
	...
	///
	/// </summary>
	public fp_Activity(string name) : base(name) { }
