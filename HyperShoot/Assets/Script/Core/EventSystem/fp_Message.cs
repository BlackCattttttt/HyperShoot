...
/// </summary>
public class fp_Message : fp_Event			// non-generic version for 0 arguments
{
	...
	///
	/// </summary>
	public fp_Message(string name) : base(name)
	{
		InitFields();
	}
	...
	protected override void InitFields()
	{
		...
		m_DelegateTypes = new Type[] { typeof(fp_Message.Sender) };
	...
	{
		Send += (fp_Message.Sender)fp_Message.Sender.CreateDelegate(m_DelegateTypes[v], t, m);
		Refresh();
	}
...
/// </summary>
public class fp_Message<V> : fp_Message			// generic version with 1 argument
{
...
/// value.
/// </summary>
public class fp_Message<V, VResult> : fp_Message			// generic version with 1 argument and a return value
{
