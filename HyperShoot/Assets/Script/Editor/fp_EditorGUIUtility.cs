...
public static class fp_EditorGUIUtility
{
	...
	public static void ObjectList(string caption, List<UnityEngine.Object> list, Type type)
	{
		...
		if (GUILayout.Button("Add", fp_EditorGUIUtility.SmallButtonStyle, GUILayout.MinWidth(50), GUILayout.MaxWidth(50), GUILayout.MinHeight(15)))
			list.Add(null);
		GUILayout.Space(37);
