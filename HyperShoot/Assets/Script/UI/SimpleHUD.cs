...
public class SimpleHUD : MonoBehaviour
{
	...
	void Update()
	{
		...
		if ((m_Player.CurrentWeaponIndex.Get() == 0)
			|| (m_Player.CurrentWeaponType.Get() == (int)BaseWeapon.Type.Melee))
		...
		{
			HealthColor = Color.Lerp(Color.white, HealthLowColor, (fp_MathUtility.Sinus(6.0f, 0.1f, 0.0f) * 5) + 0.5f);
		...
		if ((m_Player.CurrentWeaponAmmoCount.Get() < 1) && (m_Player.CurrentWeaponType.Get() != (int)BaseWeapon.Type.Thrown))
			AmmoColor = Color.Lerp(Color.white, AmmoLowColor, (fp_MathUtility.Sinus(8.0f, 0.1f, 0.0f) * 5) + 0.5f);
		else
	...
	void DrawAmmo()
	{
		if ((m_Player.CurrentWeaponType.Get() == (int)BaseWeapon.Type.Thrown))
		{
